...
public:
    ...
    virtual vector<Point> list()=0;     //Retorna un contenedor con todos los puntos en el QuadTree. Por cada punto retorna coordenadas y su valor data(usar preorder o otros para mostrar)
